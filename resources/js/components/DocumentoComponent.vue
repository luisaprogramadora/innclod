              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-sm-12" style="text-align: center;">
                    ...
                    <h3 class="m-0">Creación de Documentos</h3>
                  </div><!-- /.col -->
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">Con este formulario se podran crear los documentos</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form id="quickForm">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <select v-model="proceso" class="form-control" id="docente">
                              <option v-for="data in procesos" :value="data">{{ data.pro_nombre }} {{ data.pro_prefijo }}</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select v-model="tipo" class="form-control" id="tipo">
                              <option v-for="data in tipos" :value="data">{{ data.tip_nombre }} {{ data.tip_prefijo }}</option>
                            </select>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="card-footer">
                          <button type="button" @click="guardarDocumento()" class="btn btn-primary">Guardar</button>
                        </div>
                      </form>
                    </div>
                    <!-- /.card -->
